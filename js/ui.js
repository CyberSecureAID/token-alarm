// ============================================================
//  ui.js — DOM rendering & UI updates v6.2
//  CAMBIOS v6.2:
//    - Botón "?" info ahora inline dentro de .stat-label,
//      pegado al texto del label. Eliminado .stat-label-row
//      como wrapper. Mejora UX: clara asociación visual
//      entre el botón y el dato al que corresponde.
// ============================================================
  ...
  return `
    <div class="card-stats-onchain" id="onchain-${address}">
      ...
      <div class="card-stats-onchain-grid">
        <div class="stat-item">
          <div class="stat-label">CONTRATO <button class="info-btn" data-info-key="verified" data-info-address="${address}">?</button></div>
...
function buildTokenCard(token, state) {
  ...
  card.innerHTML = `
    ...
    <div class="card-stats">
      <div class="stat-item">
        <div class="stat-label">VOL 24H <button class="info-btn" data-info-key="volume24h" data-info-address="${token.address}">?</button></div>
        <div class="stat-value">${formatNumber(state.volume24h)}</div>
      </div>
      <div class="stat-item">
        <div class="stat-label">LIQUIDEZ <button class="info-btn" data-info-key="liquidity" data-info-address="${token.address}">?</button></div>
        <div class="stat-value">${formatNumber(state.liquidity)}</div>
      </div>
      <div class="stat-item">
        <div class="stat-label">MKT CAP <button class="info-btn" data-info-key="marketCap" data-info-address="${token.address}">?</button></div>
        <div class="stat-value">${formatNumber(state.marketCap)}</div>
      </div>
      <div class="stat-item">
        <div class="stat-label">FDV <button class="info-btn" data-info-key="fdv" data-info-address="${token.address}">?</button></div>
        <div class="stat-value">${formatNumber(state.fdv)}</div>
      </div>
      <div class="stat-item">
        <div class="stat-label">TXNS 24H <button class="info-btn" data-info-key="txns24h" data-info-address="${token.address}">?</button></div>
    ...
    <div class="card-stats-extra">
      <div class="stat-item">
        <div class="stat-label">SUPPLY TOTAL <button class="info-btn" data-info-key="totalSupply" data-info-address="${token.address}">?</button></div>
        <div class="stat-value" id="stat-supply-${token.address}">${formatSupply(state.totalSupply)}</div>
      </div>
      <div class="stat-item">
        <div class="stat-label">PAR DESCUBIERTO <button class="info-btn" data-info-key="pairAddress" data-info-address="${token.address}">?</button></div>
...
// Delegación global de eventos para todos los botones "?"
